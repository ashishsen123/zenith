...
function bizway_optionsframework_add_admin() {
    ...
    $of_page = add_theme_page($themename, 'Theme Options', 'edit_theme_options', 'optionsframework', 'bizway_optionsframework_options_page', 'div');
...
function bizway_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1><?php _e('Get BizWay Responsive Theme PRO!', 'bizway'); ?></h1>
        <p><?php _e('You are Using the FREE Version of BizWay Theme. Upgrade to Pro Version for extra features, Contact Page Template, Gallery Page, Multiple Color Skins, Full Featured Slider, Premium Support and much more.', 'bizway'); ?> </p>
        <a href="http://www.inkthemes.com/wp-themes/bizway-responsive-wordpress-theme/" target="blank"><?php _e('Upgrade to BizWay Theme PRO &rarr;', 'bizway'); ?></a>
    ...
    <div class="wrap" id="of_container">
        ...
        <form action="" enctype="multipart/form-data" id="ofform">
            <div id="header">
                <div class="logo">
                    <h2><?php echo $themename; ?> <?php _e('Options', 'bizway'); ?></h2>
                </div>
