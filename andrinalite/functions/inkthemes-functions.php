...
function inkthemes_widgets_init() {
    ...
    register_sidebar(array(
        'name' => __('Front Page Widget Area', 'andrina-lite'),
        'id' => 'front-widget-area',
        'description' => __('Front Page widget area', 'andrina-lite'),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h4>',
        'after_title' => '</h4>',
...
add_filter('wp_title', 'inkthemes_filter_wp_title');
 ...
 * @uses	is_front_page()
 */
function inkthemes_filter_wp_title($title) {
    global $page, $paged;
