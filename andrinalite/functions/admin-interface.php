...
function inkthemes_optionsframework_add_admin() {
    ...
    register_setting('optionsframework', $option_name);
}
...
function inkthemes_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1><?php _e('Go Andrina Theme PRO!', 'andrina-lite'); ?></h1>
        <p><?php _e('You are Using the Lite Version of Andrina Theme. Upgrade to Andrina Pro for extra features, Home Page Slider, Contact Page Template, priority theme updates and more.', 'andrina-lite'); ?></p>
        <a href="<?php echo esc_url(__('http://www.inkthemes.com/wp-themes/andrina-theme/', 'andrina')); ?>" target="blank"><?php _e('Upgrade to Andrina Theme PRO &rarr;', 'andrina-lite'); ?></a>
    </div>
    <div class="wrap" id="of_container">
        <div id="of-popup-save" class="of-save-popup">
            <div class="of-save-save"><?php _e('Options Updated', 'andrina-lite'); ?></div>
        </div>
        <div id="of-popup-reset" class="of-save-popup">
            <div class="of-save-reset"><?php _e('Options Reset', 'andrina-lite'); ?></div>
        </div>
        <form action="" enctype="multipart/form-data" id="ofform">
            <?php
            settings_fields('optionsframework');
            do_settings_fields('optionsframework', '');
            ?>
            <div id="header">
                <div class="logo">
                    <h2><?php echo $themename; ?> <?php _e('Options', 'andrina-lite'); ?></h2>
                </div>
...
function inkthemes_admin_style() {
    if (isset($_REQUEST['page']) && $_REQUEST['page'] == 'optionsframework')
        wp_enqueue_style('inkthemes-adminstyle', get_template_directory_uri() . '/functions/admin-style.css', false);
}

add_action('admin_print_styles', 'inkthemes_admin_style');

function inkthemes_load_only() {
    add_action('admin_head', 'inkthemes_admin_head');
    ...
    foreach ($options as $value) {
        ...
        switch ($value['type']) {
            ...
            case 'text':
                ...
                $output .= '<input class="of-input" name="' . $value['id'] . '" id="' . $value['id'] . '" type="' . $value['type'] . '" value="' . esc_attr($val) . '" />';
                break;
            ...
            case 'textarea':
                ...
                $output .= '<textarea class="of-input" name="' . $value['id'] . '" id="' . $value['id'] . '" cols="' . $cols . '" rows="8">' . esc_textarea($ta_value) . '</textarea>';
