...
class ZOOM_Post_Slider {
    ...
    public function show_metabox() {
        ...
        $html = '<li id="wpzoom_slider_%1$d" class="%2$s">
                    ...
                    <div class="wpzoom_slide_preview"%6$s>
                        ...
                        <textarea name="wpzoom_slider[%1$d][embedCode]" class="wpzoom_slide_embed_code code" placeholder="Paste embed code here...">%5$s</textarea>

                        <div class="wpzoom_slide_actions">
                            <input name="wpzoom_slider[%1$d][imageId]" type="hidden" class="wpzoom_slide_upload_image" value="%3$s" />
                            <span class="wpzoom_slide_upload_image_button button">Choose Image</span>
                            <span class="wpzoom_slide_clear_image_button button%8$s">Remove Image</span>
                        </div>
                    </div>

                    <textarea name="wpzoom_slider[%1$d][caption]" rows="1" placeholder="Enter title" class="wpzoom_slide_caption">%7$s</textarea><br />
                    <textarea name="wpzoom_slider[%1$d][description]" rows="3" placeholder="Enter description (HTML allowed)&hellip;" class="wpzoom_slide_description">%9$s</textarea>
                </li>';
    ...
    public function assets( $hook ) {
        ...
        wp_enqueue_script( 'zoom-post-slider', WPZOOM::$assetsPath . '/js/post-slider.js', array( 'jquery', 'media-upload', 'thickbox' ), WPZOOM::$wpzoomVersion );
    }
