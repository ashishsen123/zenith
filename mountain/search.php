            ...
            <div id="content">
                  <div class="col-two"> 
                   <div class="post-wrap rounds">
	  				...
	  				<h2 class="breadcrumb"><?php _e("Search Result for","language");?> <?php the_search_query(); ?></h2> 
	  			</div></div>                                                                                 
                        <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); $blogurl = get_bloginfo('template_directory')?>
	                        <div class="post-wrap rounds">
