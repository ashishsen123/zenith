...
function inkthemes_optionsframework_options_page() {
    ...
    <div class="trail-notify">
        <h1><?php _e('Buy ToomMorel Theme PRO!', 'toommorel'); ?></h1>
        <p><?php _e('You are Using the Lite Version of ToomMorel Theme. Upgrade to Pro for exciting features, Home Page Slider, Contact Page Template, priority updates and more.', 'toommorel'); ?> </p>
        <a href="http://www.inkthemes.com/wp-themes/toommorel-theme/" target="blank"><?php _e('Upgrade to ToomMorel Theme PRO &rarr;', 'toommorel'); ?></a>

    </div>
    <div class="wrap" id="of_container">
        <div id="of-popup-save" class="of-save-popup">
            <div class="of-save-save"><?php _e('Options Updated', 'toommorel'); ?></div>
        </div>
        <div id="of-popup-reset" class="of-save-popup">
            <div class="of-save-reset"><?php _e('Options Reset', 'toommorel'); ?></div>
        </div>
        <form action="" enctype="multipart/form-data" id="ofform">
            <?php wp_nonce_field('theme-update-option'); ?>
            <div id="header">
                <div class="logo">
                    <h2><?php echo $themename; ?> <?php _e('Options', 'toommorel'); ?></h2>
                </div>
...
function inkthemes_load_only() {
    ...
    //AJAX Upload
    wp_enqueue_script('inkthemes-ajaxupload', get_stylesheet_directory_uri() . '/functions/js/ajaxupload.js', array('jquery'));
    ...
    function of_admin_head() {
        ...
        // COLOR Picker 
        wp_enqueue_style('inkthemes-colorpicker', get_stylesheet_directory_uri() . '/functions/css/colorpicker.css', false);
        wp_enqueue_script('inkthemes-colorpicker', get_stylesheet_directory_uri() . '/functions/js/colorpicker.js', array('jquery'));
        ?>
