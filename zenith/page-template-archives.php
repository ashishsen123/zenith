 ...
 *
 * This is the custom archives template.
 *
 * @package Zenith
	...
	<div class="hfeed">
		...
		<article id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
			...
			<div class="entry-content">
				...
				<h3><?php _e( 'Archives by Category', 'zenith' ); ?></h3>

				<ul class="category-archives">
					<?php wp_list_categories( array( 'feed' => __( 'RSS', 'zenith' ), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false ) ); ?>
				</ul><!-- .category-archives -->

				<h3><?php _e( 'Archives by Month', 'zenith' ); ?></h3>
